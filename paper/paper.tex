...
and rudder, requires dynamic models that provide actionable design insight, not
predictive accuracy alone. Tow-tank testing is impractical at this scale;
...
Preliminary results from field step-response experiments demonstrate the approach.
