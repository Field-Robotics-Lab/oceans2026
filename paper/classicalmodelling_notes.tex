...
\begin{outline}
\item \textbf{Framing.} Three levels evaluated on a common step-response trial. The
  classical levels are identified from that trial; Level~3 is frozen after multi-log
  training and then evaluated on the same trial. Each answers a different design
  question.
\end{outline}
